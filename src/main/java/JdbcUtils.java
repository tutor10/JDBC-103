...
public class JdbcUtils {
    ...
    public static void createTable(String tableName , String ... columName_dataType){

        StringBuilder columName_dataValue = new StringBuilder("");

        for(String w : columName_dataType){

            columName_dataValue .append(w).append(",");

        }
        columName_dataValue.deleteCharAt(columName_dataValue.length()-1);



        try {
            statement.execute(  "CREATE TABLE "+tableName+"("+columName_dataValue+")");
